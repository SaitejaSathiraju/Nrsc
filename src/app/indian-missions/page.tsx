...
// Content data for different data product sections
const sectionContent = {
  'overview': {
    title: 'Overview',
    description: 'NRSC provides comprehensive satellite data products from various Indian and international satellite missions. Our data products include optical, microwave, and hyperspectral data with different spatial, spectral, and temporal resolutions to meet diverse application requirements. These products are processed using advanced algorithms and validated through ground truth data.',
    images: [
